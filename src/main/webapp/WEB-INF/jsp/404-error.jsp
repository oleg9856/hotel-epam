...
<body class="sign error-page-wrapper background-color background-image">
	<div class="sign-container">
		...
		<div class="pane">
			<div class="headline sign-text-color">404</div>
	...
	<div class="text-container">
		<div class="headline secondary-text-color">404</div>
		...
		<div class="buttons-container">
			<a class="border-button" href="${pageContext.request.contextPath}/controller/home" target="_blank"><span
				class="fa fa-home"></span> Home Page</a> <a class="border-button"
				href="mailto:#" target="_blank"><span class="fa fa-warning"></span>
				Report Problem</a>
		</div>
	</div>
